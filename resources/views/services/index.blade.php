...
<div class="container mt-5">
    ...
    <div class="card mb-4">
        ...
        <div class="card-header">
            <a class="btn btn-primary text-white" href="{{ route('services.create') }}">Add Data </a>
        </div>
        <div class="card-body">
            <div class="datatable">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    @foreach($service as $rs)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('services.edit', $rs->id)}}"><button class="btn btn-datatable btn-icon btn-transparent-dark mr-2"><i data-feather="edit"></i></button></a>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('services.destroy', $rs->id) }}" method="POST" type="button" class="btn btn-danger p-0" >
                                                    @csrf
                                                    @method('DELETE')
