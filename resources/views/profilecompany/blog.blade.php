  ...
  <header id="header" class="header fixed-top" data-scrollto-offset="0">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center scrollto me-auto me-lg-0">
        ...
        <img src="/image_about/{{$about->image_path}}" alt=""> 
            ...
            <div class="row gy-4 posts-list">
                ...
                <div class="col-lg-6">
                    <article class="d-flex flex-column">
                        <div class="post-img">
                        <img src="/image_blog/{{ $rs->image_path }}" alt="" class="img-fluid">
                        </div>
                        <h2 class="title">
                            <a href="{{ route('profilecompany.blogdetail', $rs->id) }}">{{ $rs->title}}</a>
                        </h2>
                        <div class="meta-top">
                        <ul>
                        <li class="d-flex align-items-center mt-2"><i class="bi bi-person"></i> <a href="blog-details.html">{{ $rs->author }}</a></li>
                        <li class="d-flex align-items-center mt-2"><i class="bi bi-clock"></i> <a href="blog-details.html">{{ $rs->created_at->format('M d, Y') }}</a></li>
                        <li class="d-flex align-items-center mt-2"><i class="bi bi-chat-dots"></i> <a href="blog-details.html">{{ $commentlist->where('id_blog', $rs->id)->count() }} Comments</a></li>
                        </ul>
                        </div>
                        <div class="content">
                        ...
                        <div class="read-more mt-auto align-self-end">
                            <a href="{{ route('profilecompany.blogdetail', $rs->id) }}">Read More</a>
                        </div>
                    </article>        
                </div>    
                @endforeach
