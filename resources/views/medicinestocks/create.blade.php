...
<div class="container mt-5">
    <div class="card mb-4">
    <div class="card-header">Add Data Medicinestock</div>
        <div class="card-body">
            <form action="{{ route('medicinestocks.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="stock" id="currentStock" type="number" placeholder="Enter Your Stock" required/>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="produced_date" id="currentProduceDate" type="date" placeholder="Enter Your Produce Date" required/>
                </div>

                <div class="form-group">
                    <label class="small mb-1" for="currentExpiredDate">Expired Date</label>
                    <input class="form-control" name="expired_date" id="currentExpiredDate" type="date" placeholder="Enter Your Expired Date" required />
                </div>
